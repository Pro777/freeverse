...
const POEMS = [
  ...
  },
  {
    ...
    title: "The South",
    published_year: 1889,
    start_line: "Night, and beneath star-blazoned summer skies",
    end_line: "And leaps from dreams to hail the coming day.",
  },
  {
    source: SOURCES.lazarus1,
    slug: "the-cranes-of-ibycus",
    title: "The Cranes of Ibycus",
    published_year: 1889,
    start_line: "There was a man who watched the river flow",
    end_line: "Bore him the greetings of the deathless dead!",
  },
  {
    ...
    title: "The New Year",
    published_year: 1889,
    start_line: "Not while the snow-shroud round dead earth is rolled,",
    end_line: "For Truth and Law and Love.",
  },
  {
    source: SOURCES.lazarus2,
  ...
  },
  {
    ...
    title: "In Exile",
    published_year: 1889,
    start_line: "Twilight is here, soft breezes bow the grass,",
    end_line: "And the broad prairie melts in mist of tears.",
  },
  {
    source: SOURCES.lazarus2,
    slug: "the-valley-of-baca",
    title: "The Valley of Baca",
    published_year: 1889,
    start_line: "A brackish lake is there with bitter pools",
    end_line: "Within that valley broken and made whole.",
  },
  {
    source: SOURCES.lazarus2,
